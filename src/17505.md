...
[https://github.com/golang/go/commit/5863b7d2ce6679ec94a801bad342a06254700e2a](https://github.com/golang/go/commit/5863b7d2ce6679ec94a801bad342a06254700e2a)
...
*   **Changes to the implementations and tools**: 実装とツールの変更点。
    ...
    *   `gccgo`: gccgoのステータス。
    *   `Changes to the go command`: `go` コマンドの変更点（例: テストカバレッジ、`go get -t`、`go doc` の削除）。
...
*   Go 1.2 Release Notes (最終版): [https://go.dev/doc/go1.2](https://go.dev/doc/go1.2) (このコミットで作成されたドラフトが最終的に公開されたもの)
*   Go 1 Compatibility Promise: [https://go.dev/doc/go1compat](https://go.dev/doc/go1compat)
*   Go言語公式ドキュメント: [https://go.dev/doc/](https://go.dev/doc/)
*   Gerrit Change-ID 13597044: [https://go.dev/cl/13597044](https://go.dev/cl/13597044) (このコミットの元のコードレビュー)
