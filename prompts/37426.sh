#!/bin/bash
# Index 37426: 35244d8fd160f6aa7614f4daa7bfccda1a518510
...
1.  まず、`read_file("commit_data/37426.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/37426.md"
