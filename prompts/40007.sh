#!/bin/bash
# Index 40007: caf45cde1873360d326af974575bd254b8011901
...
1.  まず、`read_file("commit_data/40007.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/40007.md"
