...
1.  まず、`read_file("/home/violet/Project/comemo/commit_data/10636.txt")` を開いて、コミット情報を取得してください。
...
### メタデータ
- **コミットインデックス**: 10636
- **コミットハッシュ**: 8ad48b3d7ca895e80bb3389d0aec11da9db99b79
...
echo -e "\n✅ Done. Output will be saved automatically to: src/10636.md"
