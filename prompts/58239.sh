...
echo "🚀 Generating explanation for commit 58239..."
...
1.  まず、`read_file("/home/violet/Project/comemo/commit_data/58239.txt")` を開いて、コミット情報を取得してください。
...
echo -e "\n✅ Done. Output will be saved automatically to: src/58239.md"
