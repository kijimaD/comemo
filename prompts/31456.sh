...
echo "🚀 Generating explanation for commit 31456..."
...
1.  まず、`read_file("/home/violet/Project/comemo/commit_data/31456.txt")` を開いて、コミット情報を取得してください。
...
echo -e "\n✅ Done. Output will be saved automatically to: src/31456.md"
