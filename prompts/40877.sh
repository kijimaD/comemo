...
1.  まず、`read_file("/home/violet/Project/comemo/commit_data/40877.txt")` を開いて、コミット情報を取得してください。
...
echo -e "\n✅ Done. Output will be saved automatically to: src/40877.md"
