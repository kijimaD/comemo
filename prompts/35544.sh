#!/bin/bash
# Index 35544: 85f4051731f9f2d0514301470d528db94ed5781c
...
1.  まず、`read_file("commit_data/35544.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/35544.md"
