#!/bin/bash
# Index 40157: cfe232042981972dc0c7e8d741a04556ecaae3c3
...
1.  まず、`read_file("commit_data/40157.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/40157.md"
