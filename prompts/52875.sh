#!/bin/bash
# Index 52875: 8337ca094beb07001cba12a1f88926dff78c1bcd
...
1.  まず、`read_file("commit_data/52875.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/52875.md"
