#!/bin/bash
# Index 19440: 05cc78d8d32f6af6fc4373e10da0b4a12f0a1ad4
...
1.  まず、`read_file("commit_data/19440.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/19440.md"
