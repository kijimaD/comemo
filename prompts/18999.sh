#!/bin/bash
# Index 18999: daca06f2e35035ea2c9d508f9f52a23baa406885
...
1.  まず、`read_file("commit_data/18999.txt")` を実行して、コミット情報を取得してください。
...
echo -e "\n✅ Done. Copy the output above and save it as: src/18999.md"
